        ...
        >
          ...
          {activeTab === 'backend' && (
            <>
              ...
              />
              {settings.isAuthenticated && <DialoguePanel backendUrl={settings.webSocketUrl} voice={audioStreamer.conversationState} captureReady={phoneAudioRecorder.isRecording && audioStreamer.isStreaming} startVoice={audioStreamer.startConversation} endVoice={audioStreamer.endConversation} />}
            </>
          )}
